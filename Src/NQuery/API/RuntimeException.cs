...
namespace NQuery
{
	...
	/// </summary>
	[Serializable]
	public sealed class RuntimeException : NQueryException
	{
		/// <summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="RuntimeException"/> class with a specified error message and a 
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="RuntimeException"/> class with serialized data.  
		/// </summary>
		/// <param name="info">The <see cref="SerializationInfo"/> that holds the serialized object data about the exception being thrown.</param>
		/// <param name="context"> The <see cref="StreamingContext"/> that contains contextual information about the source or destination.</param>
		private RuntimeException(SerializationInfo info, StreamingContext context)
			: base(info, context)
		{
		}
	}
